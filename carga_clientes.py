...
codPaisEntry=Entry(frame,textvariable=cod_pais,width=2)
codPaisEntry.grid(row=4,column=1,sticky="w",padx=5, pady=5)
codPaisEntry.config(font="Arial 15")
...
guardarBtn=Button(frame,text="Guardar", command=lambda:grabarCli(cod_cliente.get(),nombre.get(),direccion.get(),localidad.get(),cod_pais.get(),id_tributaria.get(),condicion_venta.get(),telefono.get(),correo_electronico.get()))
